...
export default function useBlackjackGame(numberOfDecks, playerBet, resolveBet) {
    ...
    const canSplit = () => {
        // TO LOOK INTO: split on same card values or actual cards? ie can we split on K, 10?
